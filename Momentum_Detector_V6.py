...
EXECUTION_LOG_CSV = os.path.join(BASE_FOLDER, "V6_Momentum_Execution_Dump.csv")
...
def print_cli_summary(rows, output_path):
    ...
    print("============================================================")
    print("=== MOMENTUM DETECTOR V6 COMPLETE ===")
    print("============================================================")
...
def main():
    parser = argparse.ArgumentParser(description="Momentum Detector V6 - Stage/RS/Breakout Momentum Engine with post-decision analyst message")
    ...
    parser.add_argument("--us-benchmark", choices=[US_DEFAULT_BENCHMARK, US_GROWTH_BENCHMARK], default=US_DEFAULT_BENCHMARK, help="US benchmark for relative strength. Default SPY; use QQQ for Nasdaq/growth lists.")
    ...
    print("Starting Momentum Detector V6 scan...")
